...
from gempy_engine.core.data.exported_structs import ExportedFields, InterpOutput, OctreeLevel, \
    DualContouringData
import numpy
import numpy as np
...
def find_intersection_on_edge(_xyz_8: numpy.ndarray, scalar_field: numpy.ndarray,
                              scalar_at_sp: numpy.ndarray) -> DualContouringData:
