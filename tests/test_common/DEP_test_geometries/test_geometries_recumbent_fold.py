...
from tests.test_common.DEP_test_geometries.test_geometries import plot

from tests.test_common.DEP_test_geometries.solutions import recumbent_weights, recumbent_weights_d1
...
class TestRecumbentFoldCovConstructionWithDrift:
    ...
    def test_recumbent_fold_scaled_rest_ref(self, recumbent_fold_scaled):
        ...
        from tests.test_common.DEP_test_geometries.solutions import recumbent_ref, recumbent_rest, recumbent_dips
    ...
    def test_recumbent_fold_scaled_cig(self, recumbent_fold_scaled):
        ...
        from tests.test_common.DEP_test_geometries.solutions import recumbent_cgi
    ...
    def test_recumbent_fold_universal_degree_2(self, recumbent_fold_scaled):
        ...
        from tests.test_common.DEP_test_geometries.solutions import recumbent_ui
