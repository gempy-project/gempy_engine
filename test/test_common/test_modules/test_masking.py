...
def test_compute_mask(unconformity, n_oct_levels=3):
    from gempy_engine.API.interp_single._interp_single_internals import _compute_mask_array
    ...
    mask_matrices = _compute_mask_array(exported_fields_example, StackRelationType.ERODE)
    print(mask_matrices)
